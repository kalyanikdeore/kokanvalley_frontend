...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 p-55 to-white">
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <motion.a
                    ...
                    href="https://www.facebook.com/konkanvalleyagrofarms/"
                    target="_blank"
                  ...
                  <motion.a
                    whileHover={{ y: -3, scale: 1.1 }}
                    href="https://www.instagram.com/konkan.valley.agro.farms"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-white p-3 rounded-full shadow-sm text-green-600 hover:bg-green-100 transition-all duration-300"
                  >
                  ...
                  <motion.a
                    whileHover={{ y: -3, scale: 1.1 }}
                    href="https://www.linkedin.com/in/shivaji-sonone-b54946377/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-white p-3 rounded-full shadow-sm text-green-600 hover:bg-green-100 transition-all duration-300"
                  >
                  ...
                  <motion.a
                    whileHover={{ y: -3, scale: 1.1 }}
                    href="https://www.youtube.com/@KonkanVallyAgroFarms"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-white p-3 rounded-full shadow-sm text-green-600 hover:bg-green-100 transition-all duration-300"
                  >
